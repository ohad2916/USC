...
/*approximating optimal k according to heuristic*/
...
/*sorts the eign vectors (rows) by values (keys)*/
...
/*returns a the weight adjacency matrix as a new matrix*/
...
/*returns a the diagonal degree matrix as a new matrix*/
...
/*returns a the graph laplacian as a new matrix*/
